...
class BookingService extends AbstractService
{
    ...
    public function createSinglePaid(User $user, Square $square, $quantity, DateTime $dateTimeStart, DateTime $dateTimeEnd, array $bills = array(), array $meta = array())
    {
        if (! $this->connection->inTransaction()) {
            $this->connection->beginTransaction();
            $transaction = true;
        ...
        try {
            ...
            $this->getEventManager()->trigger('create.single.paid', $booking);
